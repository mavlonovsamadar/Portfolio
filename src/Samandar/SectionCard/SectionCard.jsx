            ...
            <Container>
                ...
                <h4 className="recent">Featured works</h4>
                   ...
                   <div className="imageBox">
                    ...
                    <a href="https://dynamic-router.netlify.app/">    <img src={imageCard1} alt="" className="imageCard" /></a>                    
                    </div>
                    ...
                    <div className="CardBox">
                    <div className="imageBox">
                    <a href="https://travelto-ract.netlify.app/">  <img src={imageCard2} alt="" className="imageCard"/></a>  
                    </div>
                    <div className="TextBox">
                ...
                <div className="CardBox">
                <div className="imageBox">
                       <a href="https://master--weather-react-samandar.netlify.app/"><img src={imageCard3} alt="" className="imageCard"/></a> 
                    </div>
                    <div className="TextBox">
